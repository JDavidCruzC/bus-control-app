...
-- Create paraderos table (using standard lat/lng columns)
...
-- Create ubicaciones_tiempo_real table (using standard lat/lng columns)
...
CREATE INDEX idx_paraderos_latitud_longitud ON paraderos(latitud, longitud);
CREATE INDEX idx_ubicaciones_latitud_longitud ON ubicaciones_tiempo_real(latitud, longitud);
...
-- Insert sample paraderos (coordenadas de Salinas, Ecuador)
INSERT INTO paraderos (nombre, descripcion, latitud, longitud) VALUES 
('Terminal Terrestre', 'Terminal principal de buses', -2.170042, -79.922359),
('Plaza Central', 'Centro de la ciudad', -2.169444, -79.921666),
('Mercado Municipal', 'Paradero cerca del mercado', -2.168888, -79.920833),
('Universidad', 'Campus universitario', -2.167777, -79.919722);
